                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="post"> 
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Information Security</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="infosec">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">Web Services</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="webserv">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Software Testing</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="stqa">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="ai">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Game Programming</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="gp">
                                    </div>
                                </div>
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>Roll Number</th>
          <th>Information and Network Security</th>
          <th>Web Services</th>
          <th>Software Testing</th>
          <th>Artificial Intelligence</th>
          <th>Game Programming</th>
        </tr>
      </thead>
    </table>
  </div>
